...
\begin{esboco}
\aiflag{[FIGURA A INSERIR: MOSTRAR GRAFICO DE ENTRADA DE ESCRAVIZDOS]}
\end{esboco}
...
que por inteiro entre o segundo e terceiro quartil do século XIX \aiflag{(figura 3, pg9 -- numeração do rascunho; confirmar a qual das duas figuras abaixo se refere)}.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\linewidth]{figures/cap04/trafico-total.png}
\caption{\sout{Trafico} \aiflag{Tráfico} total}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\linewidth]{figures/cap04/trafico-transatlantico.png}
\caption{Tráfico transatlântico}
\end{figure}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 18\tabcolsep) * \real{0.1122}}
  >{\raggedright\arraybackslash}p{(\linewidth - 18\tabcolsep) * \real{0.0929}}
  >{\raggedright\arraybackslash}p{(\linewidth - 18\tabcolsep) * \real{0.0978}}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 18\tabcolsep) * \real{0.0946}}
  >{\raggedright\arraybackslash}p{(\linewidth - 18\tabcolsep) * \real{0.0994}}
  >{\raggedright\arraybackslash}p{(\linewidth - 18\tabcolsep) * \real{0.0929}}@{}}
...
199.5
\end{minipage} \\
\multicolumn{10}{@{}>{\raggedright\arraybackslash}p{(\linewidth - 18\tabcolsep) * \real{1.0000} + 18\tabcolsep}@{}}{%
\begin{minipage}[b]{\linewidth}\raggedright
*O item ``Outros'' consistia em produtos como erva-mate, diamante, ouro,
...
\begin{esboco}
\aiflag{[FIGURA A INSERIR: GRÁFICO DIVIDA EXTERNA sÉCULO XIX]}
\end{esboco}
...
\begin{esboco}
Dados sobre indústria no século XIX
\end{esboco}
