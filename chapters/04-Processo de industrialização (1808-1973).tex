...
\citep{hermannetal2015,souzaprevidelli2022}. Dado o escopo da tese e do capítulo, a
...
capital -- o ponto de realização do ciclo de capital e seu retorno à
...
Esta, através de acordos restritivos à atividade industrial portuguesa e
...
para o projeto metropolitano, não do novo território, e fomentava uma
estrutura de classes baseado em larga população escrava e um conjunto
restrito de grandes proprietários de terras, que viriam a se tornar a
elite política dominante do país.

Assim, até 1808 os esforços de industrialização na colônia eram
...
de técnicas que pode ser relacionada tanto à oferta de terras, que
permitia expansão produtiva sem melhorias técnicas, como aos limites
...
identificando que ``as manufacturas e a indústria (sic) que multiplicam
e melhoram e dão mais valor aos gêneros (sic) e productos (sic) da
agricultura e das artes'' \aiflag{(fonte, alvará)}. Também em setembro daquele
...
A importância teórica desses eventos, entretanto, vai além de seu
aspecto econômico. A presença da corte em território altera a
característica da elite política nacional e uma reconfiguração de sua
...
conduzir transformações institucionais que visam mudar o papel atribuído
àquele antigo território, ou ``desenvolver-lo''. Importante notar que
tal transformação não pode ser vista como uma eliminação da dependência.
Na verdade, a dependência portuguesa em relação a Inglaterra
praticamente se ``transferiu'' para o Brasil junto com a corte, sendo
sedimentada no acordo de 1810 que dava a esta privilégios significativos
\citep{furtado2005}. Mas agora havia uma relação mais direta entre o interesse
...
significativa da capacidade de arrecadação -- e auto-financiamento -- do
...
exportação -- lembre-se aqui que aparelho fiscal ou aduaneiro não
existiam antes de 1830 --, a dominação política por uma elite cujo
interesse era preservar a renda da terra e do trabalho escravo, e não
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\linewidth]{figures/cap04/impostos_participacao_1830_1888.png}
...
medida até superior ao de barreiras
aduaneiras\citep{furtado2005}.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\linewidth]{figures/cap04/grafico1-arrecadacao.png}
\caption{Gráfico 1 --- Fonte: Arquivo Nacional. Fundo da Real Junta de Comércio}
\end{figure}

É preciso também apontar um outro efeito importante da independência: a
...
dois milhões de libras aos ingleses \aiflag{(FONTE)}. Esse acordo estabelecia
...
capital hegemônico, negando parte dos potenciais ganhos. Um sinal dessa
fragilidade é o que Furtado
...
intensificada a pressão contra o tráfico de escravizados\footnote{\aiflag{[NOTA DO AUTOR: Combate
  tráfico de escravos inglaterra]}}, consequência direta da negociação com
...
provavelmente é a desencadeadora das mais importantes transformações
internas do país.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\linewidth]{figures/cap04/chegada_escravos_slavevoyage_total.png}
...
anos 1830 e viria a ser de fato o elemento re-integrador do Brasil nos
...
um desenvolvimento econômico propriamente capitalista\footnote{Mello
  ...
  latino americanos.}, não apenas pela inserção da economia mercantil
...
\citep{mello1982} --
vide: um mercado de trabalho assalariado e um capital fixo acumulado. A
...
economia cafeeira capaz de acumualação de capital, já estivessem em
movimento.
...
vez mais deslocada para o sudeste, com a transferência da capital para o
Rio de Janeiro em 1831 -- com consumo limitado pela desvalorização
...
\subsection{A transformação na segunda metade do século XIX}\label{a-transformauxe7uxe3o-na-segunda-metade-do-suxe9culo-xix}
...
colheita, condicionam essa industrialização associada à um ciclo de
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\linewidth]{figures/cap04/figura1-modernizacao-financeira.png}
\caption{Figura 1 --- Fonte: \citep{mello2008}}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\linewidth]{figures/cap04/bancos_criados_1808_1880.png}
...
\csvautotabular{tables/estatisticas_secxix/depositos_caixa_econ_1889.csv}
\end{table}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\linewidth]{figures/cap04/depositos_caixa_econ_1889.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\linewidth]{figures/cap04/exportacoes_por_produto_1821_1890.png}
...
brasileira uma concepção de ``vocação agrícola'' do país \sout{(Curado, ano)} \aiflag{\citep{curado_industrializacao_2013}}.
Isso não implica a inexistência de um pensamento industrializador ou de
associações de classe industrial, como Barreto \sout{(ano)} \aiflag{\citeyearpar{barreto_o_2018}} mostra no caso do
...
\sout{(Barreto, ano)} \aiflag{\citep{barreto_o_2018}} e um claro domínio político das elites rurais --
especialmente as escravistas até o fim do império. Era uma expressão
ideológica que via a indústria não como substitutiva ou etapa posterior,
mas como reflexo -- positivo, mas reflexo -- da prosperidade advinda do
campo.
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\linewidth]{figures/cap04/divida_externa_1824_1950.png}
...
\csvautolongtable{tables/estatisticas_secxix/populacao_1872_1920.csv}
...
\csvautotabular{tables/estatisticas_secxix/industrias_1809_1850.csv}
\end{table}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\linewidth]{figures/cap04/fabricas_1809_1850.png}
\caption{Número de fábricas no Brasil, 1809--1850}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\linewidth]{figures/cap04/preco_cafe_1901_1950.png}
...
\sout{(Perissinoto)} \aiflag{\citep{perissinotto_ideias_2023}}. Em grande parte, e de forma pragmática, Vargas manteve o
...
soberania \sout{(fonte perissinoto)} \aiflag{\citep{perissinotto_ideias_2023}}. A atuação do governo americano, com força
...
ano)} \aiflag{\citep{perissinotto_ideias_2023,bresser-pereira_burocracia_2007}}. O outro elemento é a transformação das forças relativas entre as
...
trabalhista \sout{(vianna e villela)} \aiflag{\citep{hermann_o_2025}}. A instabilidade política voltava a se
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\linewidth]{figures/cap04/preco_cafe_1920_1980.png}
...
e na unificação do mercado de âmbito, as duas últimas através da Súmula 204 da SUMOC(Villela, 2025).
...
(Mesquita, 20214). Assim, eleito em 1963, Jango assumia com problemas similares
...
\begin{esboco}
\textbf{Eleição e volta do presidencialismo (Jango)}

Plano trienal

diagnóstico similar ao da austeridade, mas com garantias sociais e
reforma agrária
\end{esboco}

``propunha correção de preçs públicos defasados, realismo cambial,
corte de despesas, controle da expansão de crédito e aumento do
compulsório dos depósitos a vista; em contrapartida mirava apronfundas o
processo de substituição de importações; via na reforma agrária e
distribuição de renda forma de construir um mercado interno capaz de
apoiar uma expansão da economia, constrangida pelo modelo esgotado;''
